...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mstgt', choices=['mstgt'],
...
#224
#overall macs is  21.778G
# overall params is  73.697M
# testing speed ...
# The average overall latency is 29.91 ms
# FPS is 33.43 fps

# 256
# overall macs is  28.814G
# overall params is  73.697M
# testing speed ...
# The average overall latency is 30.43 ms
# FPS is 32.87 fps
...
if __name__ == "__main__":
    ...
    if args.script == "mstgt":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_MSTGT
