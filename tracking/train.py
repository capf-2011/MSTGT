...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mstgt', help='training script name')
    parser.add_argument('--config', type=str, default='MSTGT-got-256', help='yaml configure file name')
    parser.add_argument('--save_dir', type=str, default='/home/gw/Data/exp_results/MSTGT/output', help='root directory to save checkpoints, logs, and tensorboard')
    ...
    # 是否使用数据增强
    parser.add_argument('--datr', type=int, choices=[0, 1, 2], default=1)  # whether to use our data augmentation datr
...
def main():
    args = parse_args()
    if args.mode == "single":
        train_cmd = "python /home/gw/research/Tracking/pycharm_project/MSTGT/lib/train/run_training.py --script %s --config %s --save_dir %s --use_lmdb %d " \
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port %d /home/gw/research/Tracking/pycharm_project/MSTGT/lib/train/run_training.py " \
