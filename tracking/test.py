...
def main():
    ...
    parser.add_argument('--tracker_name', type=str, default='mstgt', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default='mstgt-got-256', help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='10', help='Name of save file.')
