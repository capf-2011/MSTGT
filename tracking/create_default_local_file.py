...
def parse_args():
    ...
    parser.add_argument("--workspace_dir", default='..', type=str, required=False)  # workspace dir
    parser.add_argument("--data_dir", type=str, default='/home/gw/research/SOT')
    parser.add_argument("--save_dir", type=str, default='/home/gw/Data/exp_results/MSTGT/output')
