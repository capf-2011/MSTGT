...
trackers = []
dataset_name = 'otb'#lasot_extension_subset'#uav''#otb'
"""stark"""
...
"""mstgt"""
trackers.extend(trackerlist(name='mstgt', parameter_name='MSTGT-full-256', dataset_name=dataset_name,
                            save_name='148', run_ids=None, display_name='MSTGT-full-256'))
